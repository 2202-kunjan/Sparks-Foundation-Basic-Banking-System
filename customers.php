...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form align="left" class="contacts" div="user" action="" method="POST">
       New Customer Full Name:                           <input type="text" name="name"/><br>
       ...
       <button name="submit" type="submit" id="myBtn">Register</button>
    </form>
    <br>
<?php
$dbhost="localhost";
...
$conn-> close()
 ...
 <form action="index.php" method="post"/>
   <button name="submit" type="submit">Home</button>
 </form>
  </body>
</html>
